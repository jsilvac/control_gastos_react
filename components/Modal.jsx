...
const Modal = ({
      ...
      useEffect(() => {
            if (Object.keys(gastoEditar).length > 0) {
                  ...
                  setCategria(gastoEditar.categoria)
                  ...
                  >
                        ...
                        <div className='campo'>
                              ...
                              <input
                                    id='cantidad'
                                    type='number'
                                    placeholder='Añade la cantidad del gasto: ej: 2000'
                                    value={cantidad}
                        ...
                        <div className='campo'>
                              ...
                              <select
                                    id='categoria'
                                    value={categoria}
                                    onChange={e => setCategria(e.target.value)}
                              >
                                    <option value=""> -- Seleccione -- </option>
                                    <option value="ahorro">* Ahorrro</option>
